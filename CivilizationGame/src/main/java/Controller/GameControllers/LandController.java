        ...
        for (int k = 0; k < row; k++) {
            for (int i = 0; i < 6; i++) {
                for (int j = 0; j < column; j++) {
                    ...
                    resourceChar[0] =  (map[k][j*2].getResource() == null ? " " : ConsoleColors.GREEN_BOLD_BRIGHT + map[k][j*2].getResource().getResourceType().name.substring(0,1) + ConsoleColors.RESET);
                    resourceChar[1] =  (map[k][j*2+1].getResource() == null ? " " : ConsoleColors.GREEN_BOLD_BRIGHT + map[k][j*2+1].getResource().getResourceType().name.substring(0,1)+ ConsoleColors.RESET);
                    ...
                    ownerString[0] = (map[k][j*2].getOwnerCity() == null ? "N/A" : ConsoleColors.PURPLE_BOLD_BRIGHT + map[k][j*2].getOwnerCity().getOwnerNation().getNationType().name.substring(0,3)+ ConsoleColors.RESET);
                    ownerString[1] = (map[k][j*2+1].getOwnerCity() == null ? "N/A" : ConsoleColors.PURPLE_BOLD_BRIGHT + map[k][j*2+1].getOwnerCity().getOwnerNation().getNationType().name.substring(0,3)+ ConsoleColors.RESET);
                    String[] improvementString = new String[2];
                    ownerString[0] = (map[k][j*2].getImprovement() == null ? "   " : ConsoleColors.PURPLE_BRIGHT +  map[k][j*2].getImprovement().getImprovementType().name.substring(0,3)+ ConsoleColors.RESET);
                    ownerString[1] = (map[k][j*2+1].getImprovement() == null ? "   " : ConsoleColors.PURPLE_BRIGHT +  map[k][j*2+1].getImprovement().getImprovementType().name.substring(0,3)+ ConsoleColors.RESET);
...
//                            else
//                                System.out.print("  \\______/ " + ownerString[1] + " " + improvementString[1]);
