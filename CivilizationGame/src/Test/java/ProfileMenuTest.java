...
public class ProfileMenuTest extends Tester{
    ...
    @BeforeEach
    public void setup() {
        commandMatcher = LoginCommands.getMatcher("user login -u Ali -p Ali1234",LoginCommands.loginUser);
        loginController.loginUser(commandMatcher);
    }
    @Test
    public void nicknameChangeRepetitiveWrong(){
        commandMatcher = ProfileCommands.getMatcher("profile change -n matal",ProfileCommands.changeNickname);
    ...
    public void nicknameSuccessfullyChange(){
        commandMatcher = ProfileCommands.getMatcher("profile change -n ALiNistam",ProfileCommands.changeNickname);
        if (commandMatcher.matches())
    ...
    public void changePasswordTestNewPasswordEqualsOldPassword(){
        commandMatcher = ProfileCommands.getMatcher("profile change -op Ali1234 -np Ali1234",ProfileCommands.changePassword);
        if (commandMatcher.matches())
    ...
    public void changePasswordTestWrongFlags(){
        commandMatcher = ProfileCommands.getMatcher("profile change -op Ali123 -op AliAli",ProfileCommands.changePassword);
        if (commandMatcher.matches())
    ...
    public void changePasswordTestOldPasswordWrong(){
        commandMatcher = ProfileCommands.getMatcher("profile change -op Ali123 -np AliAli",ProfileCommands.changePassword);
        if (commandMatcher.matches())
    ...
    public void changePasswordTestSuccessful(){
        commandMatcher = ProfileCommands.getMatcher("profile change -op Ali1234 -np AliAli",ProfileCommands.changePassword);
        if (commandMatcher.matches())
    ...
    public void changePasswordTestSuccessfulChangingFlags(){
        commandMatcher = ProfileCommands.getMatcher("profile change -np Ali1234 -op AliAli",ProfileCommands.changePassword);
        if (commandMatcher.matches())
            Assert.assertEquals("password is incorrect",profileController.changePassword(user,commandMatcher));
    }
    ...
    public void removingAccountTestWrongPassword(){
        commandMatcher = ProfileCommands.getMatcher("remove account -p Ali123", ProfileCommands.removeAccount);
        if (commandMatcher.matches())
    ...
    public void removingAccountTestSuccessful(){
        commandMatcher = ProfileCommands.getMatcher("remove account -p Ali1234",ProfileCommands.removeAccount);
        if (commandMatcher.matches())
